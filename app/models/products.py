...
from sqlalchemy import String, Boolean, Integer, Numeric, DateTime, Computed, Index
...
class Product(Base):
    ...
    rating: Mapped[Decimal] = mapped_column(Numeric(10, 1), default=0.0, server_default='0.0', nullable=False)
